...
Chinese academic paper prompt manager (中文学术论文提示词管理器) — a single-file HTML application (`prompt_manager.html`) that helps users configure parameters, manage outlines, and generate structured prompts for AI-assisted Chinese academic paper writing.
